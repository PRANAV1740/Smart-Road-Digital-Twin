...
<head>
    ...
    <title>Smart Road Digital Twin ΓÇö RoadSense ML</title>
        ...
        <div class="sidebar">
            <div class="glass-card">
                ...
                <div class="preset-grid">
                    <div class="preset-btn" onclick="applyPreset('smooth')">Γ£¿ Smooth</div>
                    <div class="preset-btn" onclick="applyPreset('pothole')">≡ƒò│∩╕Å Pothole</div>
                    <div class="preset-btn" onclick="applyPreset('bump')">≡ƒÜº Speed Bump</div>
                    <div class="preset-btn" onclick="applyPreset('braking')">≡ƒ¢æ Hard Brake</div>
                </div>
...
&nbsp;&nbsp;"az": 14.50<br>
    ...
    <footer>
        Smart Road Digital Twin &copy; 2026 ΓÇö RoadSense ML Vercel Deployment Ready
    </footer>
